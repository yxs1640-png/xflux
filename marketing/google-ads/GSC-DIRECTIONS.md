...
### Headlines (add 3–5, replace weakest)

- Twitter Alerts From $19/mo
- Skip the $5K X API Stream
...
If adding a second Search campaign (see `MAKE-AUTOMATION-CAMPAIGN.md` pattern):

**Ad group: Trading alerts**

Phrase match keywords:

- "twitter trading alerts"
- "stock market twitter monitor"
- "twitter webhook trading"
- "x api streaming alternative"
